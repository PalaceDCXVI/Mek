...
void AppMain() {
	...
	framebuff[1]->CreateDepthTexture(SCREEN_SIZE.x / 4, SCREEN_SIZE.y / 4);
	framebuff[1]->CreateColorTexture(1, SCREEN_SIZE.x / 4, SCREEN_SIZE.y / 4);
	framebuff[2] = new Framebuffer();
	framebuff[2]->CreateDepthTexture(SCREEN_SIZE.x / 4, SCREEN_SIZE.y / 4);
	framebuff[2]->CreateColorTexture(1, SCREEN_SIZE.x / 4, SCREEN_SIZE.y / 4);
